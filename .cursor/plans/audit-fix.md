...
- [x] Контент маршрута внутри `<main>`.
...
- [x] Белый текст на `#e07c2e` довести до AA (~4.5:1 для 16px).
...
- [x] Соцкнопки и бургер ≥ 44×44 на узких экранах.
...
- [x] `.page` растягивается в колонке `.app`.
