      ...
      <RevealItem tag="div" class="cta-inner">
        ...
        <div class="cta-contacts">
          ...
          <div class="meta">
            ...
            <span v-else>✉️ обратная связь через WhatsApp</span>
            <span class="dot">·</span>
...
.cta h2 { font-size: clamp(24px, 3vw, 34px); color: #fff; max-width: 700px; margin: 0 auto 14px; }
.cta p { font-size: 17px; opacity: 0.85; max-width: 560px; margin: 0 auto 26px; line-height: 1.6; }
...
.cta-contacts { display: flex; flex-direction: column; align-items: center; gap: 12px; }
.cta-phone {
...
.meta { display: flex; gap: 10px; align-items: center; font-size: 15px; opacity: 0.85; flex-wrap: wrap; justify-content: center; }
.dot { opacity: 0.5; }
</style>
