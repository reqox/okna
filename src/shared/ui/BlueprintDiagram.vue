  ...
  <div class="blueprint" :class="variant">
    ...
    >
      ...
      <template v-if="variant === 'window'">
        ...
        <text x="220" y="352" text-anchor="middle" class="bp-label">
          1450 мм
        </text>
        <!-- dimension: height -->
      ...
      <template v-else-if="variant === 'ceiling'">
        ...
        <text x="220" y="322" text-anchor="middle" class="bp-label">
          до 30 м² / 1 день
        </text>
      </template>
      ...
      <template v-else>
        ...
        <text x="200" y="352" text-anchor="middle" class="bp-label">
          Δ ≤ 0,5 мм
        </text>
      </template>
    </svg>
